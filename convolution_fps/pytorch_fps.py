...
class ConvNet(nn.Module):
  def __init__(self):
    ...
    self.layer1 = nn.Conv2d(3, 32, kernel_len, stride=1)
    self.layer2 = nn.Conv2d(32, 64, kernel_len, stride=1)
    self.layer3 = nn.Conv2d(64, 64, kernel_len, stride=1)
